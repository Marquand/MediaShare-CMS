...
class GuestBookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MediashareGuestBookBundle:GuestBook')->findBy(array(), array('position' => 'ASC'));

        return $this->render('MediashareGuestBookBundle:GuestBook:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MediashareGuestBookBundle:GuestBook')->find($id);
        ...
        return $this->render('MediashareGuestBookBundle:GuestBook:show.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MediashareGuestBookBundle:GuestBook:edit.html.twig', array(
            'entity' => $entity,
